...
DISCLAIMER = (
    "\n\n⚠️ Це автоматизований AI-аналіз на основі наявних даних. Він НЕ є "
    "юридичним висновком, доказом порушення чи звинуваченням. Висновки "
    "можуть бути помилковими або неповними через обмеженість даних. Для "
    "остаточної оцінки необхідна перевірка людиною-експертом та, за потреби, "
    "звернення до профільних органів (АМКУ, ДАСУ, НАЗК)."
)
...
async def generate_ai_explanation(
    ...
    """
    Згенерувати структурований AI-аналіз підозрілості тендера через Groq.

    Returns:
        Текстовий аналіз за 8 критеріями + фінальна оцінка + застереження, або None
    """
...
Тобі надано дані про тендер. Проаналізуй їх і оціни рівень підозрілості за наступними критеріями:
...
- Загальну оцінку підозрілості (за шкалою 1–10)
- Список 2–4 головних "червоних прапорців", якщо вони є

Не роби категоричних тверджень на кшталт "це корупція" чи "це незаконно" — використовуй формулювання "може свідчити про", "викликає питання", "варто перевірити додатково".
