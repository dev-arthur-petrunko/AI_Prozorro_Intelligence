...
- **📈 Розширені KPI дашборду** — економія на торгах, частка тендерів з одним учасником, гістограма розподілу Індексу ризику (AI) та блок «Скоро закриваються» з дедлайнами активних тендерів
- **📅 Щоденні звіти** — зведення дашборду за сьогодні + автоматична відправка в Telegram через n8n webhook 2 рази на день: о 10:00 та 17:00 за Києвом
...
- **Нові KPI на дашборді** — «Економія на торгах» (сума зниження ціни: очікувана вартість мінус фінальна ціна переможця по завершених конкурентних торгах) та «Частка тендерів з одним учасником» — класичні індикатори здоров'я конкуренції
- **Гістограма розподілу Індексу ризику (AI)** — скільки тендерів у зонах 0–30 / 31–55 / 56–80 / 81+: видно картину всієї вибірки, а не лише топ-10
- **Блок «Скоро закриваються»** — активні конкурентні тендери з дедлайном у найближчі 7 днів (від 10 тис. грн) з лічильником днів до закриття — проактивний блок для тих, хто хоче встигнути відреагувати

### v1.6.0 (липень 2026)

- **Новий формат Telegram-звітів** — замість короткого щоденного звіту на n8n відправляється повне плоске зведення дашборду за сьогодні (`dashboard_summary`): KPI дня, розбивка конкурентні/звіти про договір, критичні активні/завершені тендери, watchlist (індекс 40–55), найбільша ризикова закупівля
- **Новий розклад звітів** — 2 рази на день замість 4: о 10:00 та 17:00 за Києвом
- **Зручність для n8n** — усі поля зведення на верхньому рівні JSON (`{{$json.total_tenders}}` тощо), компактні записи тендерів із готовими посиланнями на Prozorro — готові дані для AI-огляду в n8n
- **Ручна перевірка вебхука** — `POST /admin/send-daily-report` відправляє те саме зведення, що й планувальник
